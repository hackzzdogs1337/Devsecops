...
urlpatterns = [
    ...
    path('users/',include(userurls,namespace='users')),
    path('users/login',LoginView.as_view(template_name='login.html'),name='login'),
    path('users/logout',LogoutView.as_view(template_name='logout.html')),
    path('shop/',include(shopurls,namespace='shop'))
]
#